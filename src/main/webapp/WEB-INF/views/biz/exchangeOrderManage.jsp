	...
	<script>
		...
		function loadOrderTable(response){
        	...
        	for(order of response.orderList){
        		...
        		const exchangeReasonDetailTd = document.createElement("td");
        		exchangeReasonDetailTd.textContent = order.exchangeDto.exchange_reason_detail;
        		tr.appendChild(exchangeReasonDetailTd);
		...
		function loadNewExchangeOrderTab() {
	        ...
	        xhr.open("get", "./getNewExchangeOrder");
	        xhr.send();
