					...
					<c:when test="${bizUser.biz_status_no eq 1}">
						...
						<div class="row my-3 mx-2 rounded-4 border">
							<div class="col my-2">
								...
								<div class="row my-2">
									<div class="col text-start">사업자 인증 후 입점이 승인되면 어서오개 판매자센터의
										모든 서비스를 이용하실 수 있습니다.</div>
								</div>
								<div class="row my-2">
									<div class="col text-start">
						...
						<div class="row mx-2 my-4 rounded-4 border">
							<div class="col my-3">
								<div class="row my-2 mx-2">
									<div class="col fs-4 text-start">판매자님은 현재 입점 승인 대기 상태입니다.</div>
								</div>
								<div class="row my-2 mx-2">
					...
					<c:when test="${bizUser.biz_status_no eq 3}">
						<div class="row mx-2 my-4 rounded-4 border">
							<div class="col my-3">
								...
								<div class="row my-2 mx-2">
									<div class="col text-start">상점 정보를 등록하시면 어서오개 판매자 서비스 센터를
										이용하실 수 있습니다.</div>
								</div>
								<div class="row my-2 mx-2">
									<div class="col text-start">
