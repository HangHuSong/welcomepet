...
<div class="row 	 fLlDaL text-secondary"
	style="background-color: rgb(244, 247, 250); padding: 2rem 1rem 5rem; font-size: 0.8em;">
		...
		<div class="row mt-1">
		  <div class="col">
		    <img  src="/welcomepet/resources/img/LOGO_%236c757d.png" style="height:2.4em; opacity: 70%;">
		  </div>
		</div>
	<div class="row mt-3">
	...
	<div class="row">
		<div class="col">제휴 문의 ads@welcomepet.co.kr</div>
	</div>
	<div class="row">
